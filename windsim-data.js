(function () {
  ...
  const SURFACES = {
    grass: { mu_s: 0.35, mu_k: 0.28, mu_r: 0.025, cr: 0.55, tint: 0x262D33, accent: 0xEC725A },
    concrete: { mu_s: 0.65, mu_k: 0.55, mu_r: 0.008, cr: 0.72, tint: 0x262D33, accent: 0xEC725A },
    hardwood: { mu_s: 0.55, mu_k: 0.48, mu_r: 0.010, cr: 0.76, tint: 0x262D33, accent: 0xEC725A },
    sand: { mu_s: 0.45, mu_k: 0.35, mu_r: 0.050, cr: 0.20, tint: 0x262D33, accent: 0xEC725A },
    ice: { mu_s: 0.08, mu_k: 0.05, mu_r: 0.003, cr: 0.42, tint: 0x262D33, accent: 0xEC725A },
    water: { mu_s: 0.20, mu_k: 0.15, mu_r: 0.040, cr: 0.10, tint: 0x262D33, accent: 0xEC725A }
  };
